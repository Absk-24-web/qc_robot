...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		QcProgramNodeService qcProgramNodeService = new QcProgramNodeService(parent);
		QcInstallationNodeService qcInstallationNodeService = new QcInstallationNodeService(parent);
